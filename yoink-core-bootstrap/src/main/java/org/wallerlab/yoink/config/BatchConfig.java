...
public class BatchConfig {
    ...
    @Bean
    public org.springframework.batch.core.Job importBootstrapJob() {
    ...
    public Step bootstrapStep(StepBuilderFactory sbf, ItemReader<JAXBElement<IDatablockType>> reader,
        ...
        return sbf.get("bootstrap").<JAXBElement<IDatablockType>, MolecularSystem>chunk(1)
                .reader(reader)
    ...
    public ItemReader<JAXBElement<IDatablockType>> reader() {
        ...
        try {
            ...
            resources = appContext.getResources("file:/Users/christian/IdeaProjects/yoink/inputs/pdbml/*.xml");
     ...
     * @param stepBuilderFactory          -
     *                                    {@link org.springframework.batch.core.configuration.annotation.StepBuilderFactory}
     * @param cmlFilereader               -{@link org.springframework.batch.item.ItemReader}
     * @param serialAdaptiveQMMMProcessor -{@link org.springframework.batch.item.ItemProcessor}
     * @param cmlFileResponseWriter       -{@link org.springframework.batch.item.ItemWriter}
     * @return Step -{@link org.springframework.batch.core.Step}
     */
    @Bean
     ...
     *
     * @return Item Reader bean -{@link org.springframework.batch.item.xml.StaxEventItemReader<>}
     */
    @Bean
     ...
     *
     * @return -{@link org.springframework.batch.item.jms.JmsItemReader<>}
     */
    @Bean
     ...
     *
     * @return -{@link org.springframework.batch.item.jms.JmsItemWriter<>}
     */
    @Bean
